...
//    TaoFaceFilter taoFaceFilter;
    ...
    public boolean isCameraSwitched = false;
...
//                if (taoBeautyFilter != null) {
//                   return taoBeautyFilter.customFilterProcess(t2, textureWidth, textureHeight, extra);
//                }
//                return inputTexture;
                //todo --- hteffect start ---
                if (isCameraSwitched) {
                ...
                if (!isRenderInit) {
                    isRenderInit = HTEffect.shareInstance()
                        .initTextureRenderer(textureWidth, textureHeight,
                ...
                return HTEffect.shareInstance().processTexture(inputTexture);
